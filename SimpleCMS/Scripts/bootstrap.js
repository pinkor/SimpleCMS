...
Ext.Loader.addClassPathMappings({
    "SimpleCMS.Application": "Scripts/app/application.js",
    "Ext.Msg": "Scripts/ext/src/window/MessageBox.js",
    "Ext": "Scripts/ext/src",
    "Ext.rtl.EventObjectImpl": "Scripts/ext/src/rtl/EventObject.js",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "SimpleCMS.Application": [],
  "Ext.ux.grid.filter.ListFilter": [],
  "Ext.ux.ajax.XmlSimlet": [],
  "Ext.ux.event.Driver": [],
  "Ext.ux.dd.PanelFieldDragZone": [],
  "Ext.ux.DataView.DragSelector": [],
  "SimpleCMS.controller.Main": [],
  "Ext.ux.grid.menu.ListMenu": [],
  "Ext.ux.GMapPanel": [],
  "SimpleCMS.view.Viewport": [],
